...
class PublicApiRecipeTest(TestCase):
    ...
    def test_auth_required(self):
        """Test that authentication is requiredr"""
...
class PrivateApiRecipeTest(TestCase):
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ingredient2 = sample_ingredient(user=self.user, name='Vegan cheese')
...
class RecipeImageUploadTests(TestCase):
    ...
    #  tearDown is a function that's gonna running after the tests ends
    def tearDown(self):
    ...
    def test_upload_image_to_recipe(self):
        ...
        # Cretaes a name temporary file in the system in a random location
        with tempfile.NamedTemporaryFile(suffix='.jpg') as ntf:
            # Creates and sava the new image (this case a small black square)
            img = Image.new('RGB', (10, 10))
            img.save(ntf, format='JPEG')
            # When you save a file, it goes to the end of it.
            # Than, you have to use seek(0) to set up back to
            # the beginning of the file
            ntf.seek(0)
            # format multipart means multipart form request
    ...
    def test_filter_recipes_by_ingredients(self):
        """Test returning recipes by ingredient"""
